export default function Soporte() {
  return (
    <>
      <div className="bg-[url('https://billboard.ar/wp-content/uploads/2025/03/6769d56f16bec8fc4c4c3782_arb_dia1__mazza.ph-01164-1-scaled.jpeg')] w-full h-auto flex flex-col items-center justify-center gap-20 p-12 md:flex-row">
